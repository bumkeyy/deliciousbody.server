...
# RecommendList Test
class RecommendTest(APITransactionTestCase):
    ...
    def setUp(self):
        ...
        self.client.post(userinfo_url, {'interested_part':'0'})
    ...
    def test_main(self):
        print('------------------RecommendTest Start------------------')
        self._get_recommend()
        print('Success : Recommend_get_recommend')
        print('')